 ...
 */
public class GraphListActivity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.graph_detail_container) != null) {
            ...
            ((GraphListFragment) getSupportFragmentManager()
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(GraphDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(GraphDetailFragment.ARG_ITEM_ID, id);
